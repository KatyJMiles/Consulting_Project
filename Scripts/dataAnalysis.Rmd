...
pdf("../Output/processData_plots.pdf")
# Create grids for each group (3 total groups)
plot_grid = cowplot::plot_grid(plotlist = plots[1:6])
grid.arrange(arrangeGrob(plot_grid, bottom = x_label))
dev.off()

#Create pdf of plot grids
pdf("../Output/biochemicalData_plots.pdf")
# Create grids for each group (3 total groups)
plot_grid = cowplot::plot_grid(plotlist = plots[7:23])
grid.arrange(arrangeGrob(plot_grid, bottom = x_label))
dev.off()

pdf("../Output/sensoryData_plots.pdf")
# Create grids for each group (3 total groups)
plot_grid = cowplot::plot_grid(plotlist = plots[24:42])
grid.arrange(arrangeGrob(plot_grid, bottom = x_label))
dev.off()
